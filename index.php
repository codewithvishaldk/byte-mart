      ...
      <div class="testimonials-box">
        ...
        <div class="testimonial">
          ...
          <div class="testimonial-card">
            <img src="https://iili.io/2Ds2ZVs.th.jpg" alt="vishal" class="testimonial-banner" width="80" height="80" style="border: redius 50%;" />

            <p class="testimonial-name">Vishal</p>

            <p class="testimonial-title">CEO & Founder Byte-mart</p>
